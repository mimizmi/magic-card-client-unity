...
|---|---|---|
| Static | package/version pins, dependency direction, forbidden references, fixture shape | API compatibility across upgrades |
| EditMode | frame codec, message IDs, selected DTO names, fakes, DI, third-party type resolution, optional xLua probe | real TCP, catalogs, Lua VM, gameplay |
